import { parseChaptersFromDescription, type ParsedChapter } from './parseDescription.js';
...
export interface ReconcileOptions {
  ...
  youtubeChapters?: Array<{ title: string; start_s: number }>;
}

export function reconcileChapters({ videoMeta, youtubeChapters }: ReconcileOptions): Chapter[] {
...
function buildChapters(rawChapters: Array<{ title: string; time_s?: number; start_s?: number }>, duration_s: number): Chapter[] {
